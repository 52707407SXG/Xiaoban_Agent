...
- User wants **Xiaoban itself to drive a browser** → use Xiaoban' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
