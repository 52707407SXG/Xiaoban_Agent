...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Xiaoban-Agent |
| License | MIT |
...
Helper script path: `~/.xiaoban/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.xiaoban/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.xiaoban/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.xiaoban/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
