# Xiaoban Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.xiaoban/plugins/xiaoban-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.xiaoban/plugins/xiaoban-achievements/scan_checkpoint.json`.
