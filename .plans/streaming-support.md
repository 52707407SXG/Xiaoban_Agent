# Streaming LLM Response Support for Xiaoban-Agent
...
```
XIAOBAN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("XIAOBAN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `xiaoban_cli/config.py` | 1 | +streaming config defaults |
...
XIAOBAN_STREAMING_ENABLED=true
```
