...
One ``CDPSupervisor`` runs per Xiaoban ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "xiaoban-dialog-bridge.invalid"
...
(() => {
  if (window.__xiaobanDialogBridgeInstalled) return;
  window.__xiaobanDialogBridgeInstalled = true;
  const ENDPOINT = "http://xiaoban-dialog-bridge.invalid/";
