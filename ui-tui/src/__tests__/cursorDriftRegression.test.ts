 ...
 *
 * Symptom: in `xiaoban --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@xiaoban/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using xiaoban --tui and as i type multiline my caret at the end will often ' +
