...
`xiaoban backup` creates a zip archive of the entire ~/.hermes/ directory
...
def run_import(args) -> None:
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        # Guidance
        print()
        if not (hermes_root / "xiaoban-agent").is_dir():
...
def restore_cron_jobs_if_emptied(
    ...
    Args:
        ...
        hermes_home: Override for the Xiaoban home directory (tests).
