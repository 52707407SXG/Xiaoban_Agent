...
def remove_path_from_shell_configs():
    ...
    for config_path in configs:
        try:
            ...
            # Remove lines containing xiaoban-agent or hermes PATH entries
            new_lines = []
            skip_next = False
    ...
    for wrapper in wrapper_paths:
        if wrapper.exists():
            try:
                ...
                if 'hermes_cli' in content or 'xiaoban-agent' in content:
                    wrapper.unlink()
...
def _uninstall_profile(profile) -> None:
    ...
    #    Use `python -m hermes_cli.main` so we don't depend on a `xiaoban`
...
def run_gui_uninstall(args):
    ...
    print(color("│         ⚕ Xiaoban Chat GUI Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    if agent_is_installed(hermes_home):
        ...
        print(f"  • The Hermes agent at {hermes_home / 'xiaoban-agent'}")
    ...
    print(color("└─────────────────────────────────────────────────────────┘", Colors.GREEN, Colors.BOLD))
    print()
    print("The Xiaoban agent is still installed. Run 'hermes' to use the CLI,")
...
def run_uninstall(args):
    ...
    print()
    print(color("┌─────────────────────────────────────────────────────────┐", Colors.MAGENTA, Colors.BOLD))
    print(color("│            ⚕ Xiaoban-Agent Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    *,
    ...
    try:
        if project_root.exists():
            # If the install is inside ~/.hermes/, just remove the xiaoban-agent subdir
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  iex (irm https://xiaoban-agent.nousresearch.com/install.ps1)", Colors.DIM))
        else:
            print(color("  curl -fsSL https://xiaoban-agent.nousresearch.com/install.sh | bash", Colors.DIM))
        print()
    ...
    print()
    print("Thank you for using Xiaoban-Agent! ⚕")
    print()
