...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.xiaoban/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.xiaoban/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Xiaoban installs package this)
