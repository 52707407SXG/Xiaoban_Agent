...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/xiaoban'
 ...
 * log inline — the GUI equivalent of the install step `xiaoban tools` runs
