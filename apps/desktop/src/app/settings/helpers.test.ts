...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: XiaobanConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: XiaobanConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // XIAOBAN_QWEN_ shares the XIAOBAN_ stem with other integrations.
      expect(providerGroup('XIAOBAN_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
