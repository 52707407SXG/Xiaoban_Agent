"""Tests for the ``xiaoban prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from xiaoban_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(xiaoban_home, memory_text="", user_text=""):
    mem_dir = xiaoban_home / "memories"
...
def _seed_skill(xiaoban_home, name, description):
    skill_dir = xiaoban_home / "skills" / "demo" / name
