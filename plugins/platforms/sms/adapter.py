...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Xiaoban gateway adapter.

    Each inbound phone number gets its own Xiaoban session (multi-tenant).
...
# static dict in xiaoban_cli/gateway.py, and the _send_sms dispatch in
