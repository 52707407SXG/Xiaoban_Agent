...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/xiaoban'
...
// / Program Files), which buried any files Xiaoban wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.xiaobanDesktop` is
    ...
    const settings = window.xiaobanDesktop?.settings
