...
_DOCS_BASE = "https://xiaoban-agent.nousresearch.com/docs"
...
# display_hermes_home imported lazily at call sites (stale-module safety during xiaoban update)
...
def print_noninteractive_setup_guidance(reason: str | None = None) -> None:
    ...
    print()
    print(color("⚕ Xiaoban Setup — Non-interactive mode", Colors.CYAN, Colors.BOLD))
    print()
    if reason:
        print_info(reason)
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://xiaoban-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://xiaoban-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def _run_portal_one_shot(config: dict) -> None:
    ...
    print(color("│     ⚕ Xiaoban Setup — Nous Portal (one-shot)             │", Colors.MAGENTA))
    print(
        color(
            "└─────────────────────────────────────────────────────────┘",
            Colors.MAGENTA,
...
def run_setup_wizard(args):
    ...
    print(
        color(
            "│             ⚕ Xiaoban-Agent Setup Wizard                │", Colors.MAGENTA
        )
    )
    print(
        color(
