...
const SIDEBAR_COLLAPSED_KEY = "xiaoban-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="xiaoban-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="xiaoban-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const { activeAction, isBusy, isRunning, pendingAction, runAction } =
    useSystemActions();
  const canUpdateXiaoban = status?.can_update_xiaoban === true;
  ...
  if (canUpdateXiaoban) {
    items.push({
      action: "update",
      icon: Download,
      label: t.status.updateXiaoban,
      runningLabel: t.status.updatingXiaoban,
      spin: false,
    });
  }
