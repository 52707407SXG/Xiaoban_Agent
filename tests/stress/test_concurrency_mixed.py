...
def worker_loop(worker_id: int, xiaoban_home: str, result_file: str) -> None:
...
def reclaimer_loop(xiaoban_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="xiaoban_mixed_stress_")
