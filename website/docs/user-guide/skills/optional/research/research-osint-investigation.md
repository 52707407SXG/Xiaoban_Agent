...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Xiaoban-Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $XIAOBAN_OSINT_CACHE/icij/ (default: ~/.cache/xiaoban-osint/icij/).
...
# Set XIAOBAN_OSINT_UA=your-app/1.0 (your@email) to identify yourself
