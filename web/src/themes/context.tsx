...
const STORAGE_KEY = "xiaoban-dashboard-theme";
...
const FONT_STORAGE_KEY = "xiaoban-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `xiaoban_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "xiaoban-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-xiaoban-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-xiaoban-theme-font", "true");
