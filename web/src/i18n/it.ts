...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateXiaoban: "Aggiorna Xiaoban",
    updatingXiaoban: "Aggiornamento di Xiaoban…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Xiaoban (parità con `xiaoban plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.xiaoban/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.xiaoban/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.xiaoban/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Xiaoban da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Xiaoban in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Xiaoban di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Xiaoban rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Xiaoban sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
