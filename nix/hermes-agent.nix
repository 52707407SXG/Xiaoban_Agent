...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    cp -r ${hermesWeb} $out/share/xiaoban-agent/web_dist
    ...
    ${lib.concatMapStringsSep "\n"
      (name: ''
        makeWrapper ${hermesVenv}/bin/${name} $out/bin/${name} \
          ...
          --set HERMES_BUNDLED_SKILLS $out/share/xiaoban-agent/skills \
          --set HERMES_BUNDLED_PLUGINS $out/share/xiaoban-agent/plugins \
          --set HERMES_BUNDLED_LOCALES $out/share/xiaoban-agent/locales \
          --set HERMES_WEB_DIST $out/share/xiaoban-agent/web_dist \
