...
cd apps/desktop
XCURSOR_SIZE=24 XIAOBAN_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/xiaoban-typing
# → /tmp/xiaoban-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/xiaoban-typing.before.heapsnapshot
# → /tmp/xiaoban-typing.after.heapsnapshot
```
