...
import { launchXiaobanDesktop } from '../store'
import { Rocket, AlertCircle } from 'lucide-react'

/*
 * Success screen. XIAOBAN AGENT wordmark stays as the visual anchor
 ...
 * Xiaoban.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchXiaobanDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="xiaoban-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Xiaoban is ready</span>
          </span>
          <span aria-hidden="true">Xiaoban is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Xiaoban'}
      </Button>
