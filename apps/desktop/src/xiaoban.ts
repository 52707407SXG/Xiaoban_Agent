import { JsonRpcGatewayClient } from '@xiaoban/shared'
...
export class XiaobanGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Xiaoban gateway connection closed',
      connectErrorMessage: 'Could not connect to Xiaoban gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Xiaoban gateway is not connected',
...
// the call; each pooled backend already has its own XIAOBAN_HOME, so no backend
...
export async function listSessions(
  ...
  const result = await window.xiaobanDesktop.api<PaginatedSessions>({
...
export function setSessionArchived(id: string, archived: boolean, profile?: string | null): Promise<{ ok: boolean }> {
  return window.xiaobanDesktop.api<{ ok: boolean }>({
    ...(profile ? { profile } : {}),
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return window.xiaobanDesktop.api<SessionSearchResponse>({
...
export function getSession(id: string, profile?: string | null): Promise<SessionInfo> {
  ...
  return window.xiaobanDesktop.api<SessionInfo>({
    ...(profile ? { profile } : {}),
...
export function getSessionMessages(id: string, profile?: string | null): Promise<SessionMessagesResponse> {
  ...
  return window.xiaobanDesktop.api<SessionMessagesResponse>({
    ...(profile ? { profile } : {}),
...
export function renameSession(
  ...
  return window.xiaobanDesktop.api<{ ok: boolean; title: string }>({
    ...(profile ? { profile } : {}),
    path: `/api/sessions/${encodeURIComponent(id)}`,
    method: 'PATCH',
...
export function getGlobalModelInfo(): Promise<ModelInfoResponse> {
  return window.xiaobanDesktop.api<ModelInfoResponse>({
    ...profileScoped(),
    path: '/api/model/info'
  })
}
...
export function getStatus(): Promise<StatusResponse> {
  return window.xiaobanDesktop.api<StatusResponse>({
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return window.xiaobanDesktop.api<LogsResponse>({
    ...profileScoped(),
    path: suffix ? `/api/logs?${suffix}` : '/api/logs'
  })
}

export function getXiaobanConfig(): Promise<XiaobanConfig> {
  return window.xiaobanDesktop.api<XiaobanConfig>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getXiaobanConfigRecord(): Promise<XiaobanConfigRecord> {
  return window.xiaobanDesktop.api<XiaobanConfigRecord>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getXiaobanConfigDefaults(): Promise<XiaobanConfigRecord> {
  return window.xiaobanDesktop.api<XiaobanConfigRecord>({
    ...profileScoped(),
...
export function getXiaobanConfigSchema(): Promise<ConfigSchemaResponse> {
  return window.xiaobanDesktop.api<ConfigSchemaResponse>({
    ...profileScoped(),
    path: '/api/config/schema'
  })
}

export function saveXiaobanConfig(config: XiaobanConfigRecord): Promise<{ ok: boolean }> {
  return window.xiaobanDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: '/api/config',
    method: 'PUT',
...
export function getMemoryProviderConfig(provider: string): Promise<MemoryProviderConfig> {
  return window.xiaobanDesktop.api<MemoryProviderConfig>({
...
export function getEnvVars(): Promise<Record<string, EnvVarInfo>> {
  return window.xiaobanDesktop.api<Record<string, EnvVarInfo>>({
    ...profileScoped(),
    path: '/api/env'
  })
}
...
export function validateProviderCredential(
  ...
  return window.xiaobanDesktop.api<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function revealEnvVar(key: string): Promise<{ key: string; value: string }> {
  return window.xiaobanDesktop.api<{ key: string; value: string }>({
    ...profileScoped(),
    path: '/api/env/reveal',
    method: 'POST',
    body: { key }
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return window.xiaobanDesktop.api<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function disconnectOAuthProvider(providerId: string): Promise<{ ok: boolean; provider: string }> {
  return window.xiaobanDesktop.api<{ ok: boolean; provider: string }>({
    ...profileScoped(),
...
export function startOAuthLogin(providerId: string): Promise<OAuthStartResponse> {
  return window.xiaobanDesktop.api<OAuthStartResponse>({
    ...profileScoped(),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return window.xiaobanDesktop.api<OAuthSubmitResponse>({
    ...profileScoped(),
...
export function pollOAuthSession(providerId: string, sessionId: string): Promise<OAuthPollResponse> {
  return window.xiaobanDesktop.api<OAuthPollResponse>({
    ...profileScoped(),
...
export function startMemoryProviderOAuth(provider: string): Promise<MemoryProviderOAuthStatus> {
  return window.xiaobanDesktop.api<MemoryProviderOAuthStatus>({
    ...profileScoped(),
...
export function getSkills(): Promise<SkillInfo[]> {
  return window.xiaobanDesktop.api<SkillInfo[]>({
    ...profileScoped(),
    path: '/api/skills'
  })
}
...
export function toggleSkill(name: string, enabled: boolean): Promise<{ ok: boolean; name: string; enabled: boolean }> {
  return window.xiaobanDesktop.api<{ ok: boolean; name: string; enabled: boolean }>({
    ...profileScoped(),
...
export function getToolsets(): Promise<ToolsetInfo[]> {
  return window.xiaobanDesktop.api<ToolsetInfo[]>({
    ...profileScoped(),
...
export function getToolsetConfig(name: string): Promise<ToolsetConfig> {
  return window.xiaobanDesktop.api<ToolsetConfig>({
    ...profileScoped(),
...
export function selectToolsetProvider(
  ...
  return window.xiaobanDesktop.api<{ ok: boolean; name: string; provider: string }>({
    ...profileScoped(),
...
export function runToolsetPostSetup(name: string, key: string): Promise<ActionResponse & { key: string }> {
  return window.xiaobanDesktop.api<ActionResponse & { key: string }>({
    ...profileScoped(),
...
export function getComputerUseStatus(): Promise<ComputerUseStatus> {
  return window.xiaobanDesktop.api<ComputerUseStatus>({
    ...profileScoped(),
...
export function grantComputerUsePermissions(): Promise<ActionResponse> {
  return window.xiaobanDesktop.api<ActionResponse>({
    ...profileScoped(),
...
export function getMessagingPlatforms(): Promise<MessagingPlatformsResponse> {
  return window.xiaobanDesktop.api<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return window.xiaobanDesktop.api<{ ok: boolean; platform: string }>({
...
export function testMessagingPlatform(platformId: string): Promise<MessagingPlatformTestResponse> {
  return window.xiaobanDesktop.api<MessagingPlatformTestResponse>({
...
export function getCronJobs(): Promise<CronJob[]> {
  return window.xiaobanDesktop.api<CronJob[]>({
    path: '/api/cron/jobs'
  })
}
...
export async function getCronJobRuns(jobId: string, limit = 20): Promise<SessionInfo[]> {
  const { runs } = await window.xiaobanDesktop.api<{ runs: SessionInfo[] }>({
...
export function getProfiles(): Promise<ProfilesResponse> {
  return window.xiaobanDesktop.api<ProfilesResponse>({
    path: '/api/profiles'
  })
}

export function createProfile(body: ProfileCreatePayload): Promise<{ name: string; ok: boolean; path: string }> {
  return window.xiaobanDesktop.api<{ name: string; ok: boolean; path: string }>({
    path: '/api/profiles',
    method: 'POST',
    body
  })
...
export function deleteProfile(name: string): Promise<{ ok: boolean; path: string }> {
  return window.xiaobanDesktop.api<{ ok: boolean; path: string }>({
    path: `/api/profiles/${encodeURIComponent(name)}`,
    method: 'DELETE'
  })
}
...
export function getProfileSoul(name: string): Promise<ProfileSoul> {
  return window.xiaobanDesktop.api<ProfileSoul>({
...
export function getProfileSetupCommand(name: string): Promise<ProfileSetupCommand> {
  return window.xiaobanDesktop.api<ProfileSetupCommand>({
    path: `/api/profiles/${encodeURIComponent(name)}/setup-command`
  })
}

export function getUsageAnalytics(days = 30): Promise<AnalyticsResponse> {
  return window.xiaobanDesktop.api<AnalyticsResponse>({
    ...profileScoped(),
...
export function getGlobalModelOptions(opts?: { refresh?: boolean }): Promise<ModelOptionsResponse> {
  return window.xiaobanDesktop.api<ModelOptionsResponse>({
    ...profileScoped(),
...
// curation `xiaoban model` does — for Nous it honors the free/paid tier so a
// free user gets a free model instead of a paid default.
export function getRecommendedDefaultModel(provider: string): Promise<RecommendedDefaultModel> {
  return window.xiaobanDesktop.api<RecommendedDefaultModel>({
    ...profileScoped(),
...
export function setGlobalModel(
  ...
  return window.xiaobanDesktop.api<{ ok: boolean; provider: string; model: string }>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body: {
...
export function getAuxiliaryModels(): Promise<AuxiliaryModelsResponse> {
  return window.xiaobanDesktop.api<AuxiliaryModelsResponse>({
    ...profileScoped(),
...
export function setModelAssignment(body: ModelAssignmentRequest): Promise<ModelAssignmentResponse> {
  return window.xiaobanDesktop.api<ModelAssignmentResponse>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body
...
export function updateXiaoban(): Promise<ActionResponse> {
  return window.xiaobanDesktop.api<ActionResponse>({
    path: '/api/xiaoban/update',
    method: 'POST'
  })
}
...
export function checkXiaobanUpdate(force = false): Promise<BackendUpdateCheckResponse> {
  return window.xiaobanDesktop.api<BackendUpdateCheckResponse>({
    path: `/api/xiaoban/update/check${force ? '?force=true' : ''}`
  })
}

export function getActionStatus(name: string, lines = 200): Promise<ActionStatusResponse> {
  return window.xiaobanDesktop.api<ActionStatusResponse>({
    path: `/api/actions/${encodeURIComponent(name)}/status?lines=${Math.max(1, lines)}`
  })
}

export function transcribeAudio(dataUrl: string, mimeType?: string): Promise<AudioTranscriptionResponse> {
  return window.xiaobanDesktop.api<AudioTranscriptionResponse>({
...
export function speakText(text: string): Promise<AudioSpeakResponse> {
  return window.xiaobanDesktop.api<AudioSpeakResponse>({
...
export function getElevenLabsVoices(): Promise<ElevenLabsVoicesResponse> {
  return window.xiaobanDesktop.api<ElevenLabsVoicesResponse>({
