...
Invoked by ``xiaoban kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Xiaoban-Agent board.
...
def _profile_author() -> str:
    """Mirror of ``xiaoban_cli.kanban._profile_author``."""
    return (
