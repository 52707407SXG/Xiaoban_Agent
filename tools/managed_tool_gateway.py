...
def auth_json_path():
    """Return the Xiaoban auth store path, respecting XIAOBAN_HOME overrides."""
    return get_xiaoban_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`xiaoban tools`, banner/status paint, provider
