...
def _profile_user_agent() -> str:
    """Return a ``xiaoban-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from xiaoban_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"xiaoban-cli/{_ver}"
    except Exception:
        return "xiaoban-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # xiaoban-cli UA so the catalog endpoint is reachable.
