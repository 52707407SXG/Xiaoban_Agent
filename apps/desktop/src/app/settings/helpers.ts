import type { XiaobanConfigRecord, ToolsetInfo } from '@/types/xiaoban'
...
export function getNested(obj: XiaobanConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: XiaobanConfigRecord, path: string, value: unknown): XiaobanConfigRecord {
...
function personalityOptions(config: XiaobanConfigRecord): string[] {
