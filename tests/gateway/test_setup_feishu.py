"""Tests for _setup_feishu() in xiaoban_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("xiaoban_cli.config.save_env_value", side_effect=mock_save), \
         patch("xiaoban_cli.config.get_env_value", side_effect=mock_get), \
         patch("xiaoban_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("xiaoban_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("xiaoban_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("xiaoban_cli.cli_output.print_header"), \
         patch("xiaoban_cli.cli_output.print_info"), \
         patch("xiaoban_cli.cli_output.print_success"), \
         patch("xiaoban_cli.cli_output.print_warning"), \
         patch("xiaoban_cli.cli_output.print_error"), \
