...
try:
    ...
    _XIAOBAN_VERSION = "0.0.0"

_APP_VERSION = _XIAOBAN_VERSION
_BOT_VERSION = _XIAOBAN_VERSION
_YUANBAO_INSTANCE_ID = str(XIAOBAN_INSTANCE_ID)  # single source: yuanbao_proto.XIAOBAN_INSTANCE_ID
