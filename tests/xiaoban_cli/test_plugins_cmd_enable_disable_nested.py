...
the *mutation* side: `xiaoban plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    @patch("xiaoban_cli.plugins.get_bundled_plugins_dir")
    ...
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from xiaoban_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("xiaoban_cli.plugins.get_bundled_plugins_dir")
    @patch("xiaoban_cli.plugins_cmd._plugins_dir")
    @patch("xiaoban_cli.plugins_cmd._save_disabled_set")
    @patch("xiaoban_cli.plugins_cmd._save_enabled_set")
    @patch("xiaoban_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("xiaoban_cli.plugins_cmd._get_enabled_set", return_value=set())
    def test_enable_bare_name_writes_key(
        ...
        from xiaoban_cli.plugins_cmd import cmd_enable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
    ...
    def test_disable_bare_name_writes_key_and_clears_alias(
        ...
        from xiaoban_cli.plugins_cmd import cmd_disable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
