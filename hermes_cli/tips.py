...
TIPS = [
    ...
    "xiaoban chat --source telegram tags the session for filtering in hermes sessions list.",
    ...
    "hermes mcp serve runs Xiaoban runtime as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Xiaoban home directory.",
    ...
    "Xiaoban loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Xiaoban as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "Profiles scope Xiaoban state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    "xiaoban chat --source tool tags programmatic chats so they don't clutter hermes sessions list.",
