...
```bash
pip install git+https://github.com/52707407SXG/Xiaoban-Agent.git
```

或使用 [uv](https://docs.astral.sh/uv/)：

```bash
uv pip install git+https://github.com/52707407SXG/Xiaoban-Agent.git
```

也可以在 `requirements.txt` 中固定版本：

```text
xiaoban-agent @ git+https://github.com/52707407SXG/Xiaoban-Agent.git
```
