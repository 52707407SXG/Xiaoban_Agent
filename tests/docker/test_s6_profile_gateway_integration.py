...
The unit tests in tests/xiaoban_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned xiaoban-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/xiaoban")
from xiaoban_cli.service_manager import S6ServiceManager
