...
const SIDEBAR_PINNED_STORAGE_KEY = 'xiaoban.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'xiaoban.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'xiaoban.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'xiaoban.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'xiaoban.desktop.sessionOrder'
const SIDEBAR_SESSION_ORDER_MANUAL_STORAGE_KEY = 'xiaoban.desktop.sessionOrder.manual'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'xiaoban.desktop.workspaceOrder'
const SIDEBAR_WORKSPACE_PARENT_ORDER_STORAGE_KEY = 'xiaoban.desktop.workspaceParentOrder'
const PANES_FLIPPED_STORAGE_KEY = 'xiaoban.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'xiaoban:focus-session-search'
