...
[Download the Xiaoban Desktop installer](https://github.com/52707407SXG/Xiaoban-Agent/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://github.com/52707407SXG/Xiaoban-Agent/install.sh), inspect it, then run it.
...
- **[Run Xiaoban-Agent with Nous Portal](/guides/run-hermes-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
