...
test('buildPosixCleanupScript waits for the PID, runs the uninstall module, removes bundle', () => {
  const script = buildPosixCleanupScript({
    desktopPid: 4321,
    pythonExe: '/home/x/.hermes/xiaoban-agent/venv/bin/python',
    pythonPath: null,
    agentRoot: '/home/x/.hermes/xiaoban-agent',
...
test('buildPosixCleanupScript exports PYTHONPATH when pythonPath is set (lite/full)', () => {
  const script = buildPosixCleanupScript({
    ...
    pythonPath: '/home/x/.hermes/xiaoban-agent',
    agentRoot: '/home/x/.hermes/xiaoban-agent',
  ...
  // venv is torn down.
  assert.match(script, /export PYTHONPATH='\/home\/x\/\.hermes\/xiaoban-agent'/)
