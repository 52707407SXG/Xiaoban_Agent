...
``_check_spotify_available()`` — when the user has not run ``xiaoban auth
spotify``, the tools remain registered (so they appear in ``xiaoban
...
The Spotify auth flow (``xiaoban auth spotify``), CLI plumbing, and docs
