...
required — uses aiohttp which is already a Xiaoban dependency.
...
def interactive_setup() -> None:
    ...
    ``xiaoban_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Xiaoban delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # xiaoban_cli/setup.py::_setup_mattermost function.
