...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Xiaoban agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Xiaoban agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Xiaoban agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Xiaoban agent, and all of your config, chats, secrets, and logs',
...
export function UninstallSection() {
  ...
  useEffect(() => {
    let alive = true
    const bridge = window.xiaobanDesktop?.uninstall
    if (!bridge) {
      setLoading(false)
      return
    }
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Xiaoban</p>
