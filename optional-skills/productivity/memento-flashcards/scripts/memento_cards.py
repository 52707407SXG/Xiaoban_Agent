...
Data file: $XIAOBAN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_XIAOBAN_HOME = Path(os.environ.get("XIAOBAN_HOME", Path.home() / ".xiaoban"))
DATA_DIR = _XIAOBAN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
