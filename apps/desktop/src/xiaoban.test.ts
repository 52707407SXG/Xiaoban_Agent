...
import { getSessionMessages, listAllProfileSessions, listSessions } from './xiaoban'
...
describe('Xiaoban REST session helpers', () => {
  ...
  afterEach(() => {
    vi.restoreAllMocks()
    Reflect.deleteProperty(window, 'xiaobanDesktop')
  })
