...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Xiaoban Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Xiaoban Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hermes backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
  ...
  install: {
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Xiaoban CLI or desktop instance is running. Stop any running Hermes instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
