 ...
 * `window.__XIAOBAN_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Xiaoban brand in the top bar
 ...
 *  `window.__XIAOBAN_PLUGINS__.registerSlot(...)`.
 *
