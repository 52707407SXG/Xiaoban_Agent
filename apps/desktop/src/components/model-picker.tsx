...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/xiaoban'
...
export function ModelPickerDialog({
  ...
  // the `xiaoban model` CLI picker, which shows the curated list verbatim.
