"""
Skills configuration for Xiaoban-Agent.
`xiaoban skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.xiaoban/config.yaml under:
...
from xiaoban_cli.config import cfg_get, load_config, save_config
from xiaoban_cli.colors import Colors, color
from xiaoban_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `xiaoban skills`."""
    from xiaoban_cli.curses_ui import curses_checklist
