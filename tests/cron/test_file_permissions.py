...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("xiaoban_cli.config.get_config_path", return_value=config_path), \
             patch("xiaoban_cli.config.ensure_xiaoban_home"):
    ...
    def test_ensure_xiaoban_home_sets_0700(self):
        home = Path(self.tmpdir) / ".xiaoban"
