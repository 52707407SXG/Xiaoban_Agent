/**
 * Xiaoban Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__XIAOBAN_PLUGIN_SDK__`` and
 * ``window.__XIAOBAN_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__XIAOBAN_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``XiaobanPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@xiaoban/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__XIAOBAN_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__XIAOBAN_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__XIAOBAN_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface XiaobanPluginSDK {
...
declare global {
  interface Window {
    __XIAOBAN_PLUGIN_SDK__?: XiaobanPluginSDK;
    __XIAOBAN_PLUGINS__?: PluginRegistry;
  }
}
