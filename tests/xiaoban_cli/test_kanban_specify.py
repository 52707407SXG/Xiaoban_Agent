"""Tests for the specifier module + `xiaoban kanban specify` CLI surface.
...
from xiaoban_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `xiaoban kanban …` argparse surface directly."""
