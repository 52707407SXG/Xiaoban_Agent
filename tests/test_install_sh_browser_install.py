...
Browser automation is optional. The installer should not leave Xiaoban
...
def test_install_script_skips_playwright_download_when_system_browser_exists() -> None:
    ...
    assert "Skipping Playwright browser download; Xiaoban will use the system browser." in text
