...
Trust levels:
  - builtin:   Ships with Xiaoban. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.xiaoban/\.env|\~/\.xiaoban/\.env',
     "xiaoban_env_access", "critical", "exfiltration",
     "directly references Xiaoban secrets file"),
    ...
    (r'\.xiaoban/config\.yaml|\.xiaoban/SOUL\.md',
     "xiaoban_config_mod", "critical", "persistence",
     "references Xiaoban configuration files directly"),
...
# scan. `.skillignore` is the Xiaoban-native name; `.clawhubignore` is honored
