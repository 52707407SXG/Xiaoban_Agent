...
import type { SessionInfo } from '@/xiaoban'
 ...
 * e.g. `xiaoban-agent/desktop` vs `xiaoban-agent-wt-rtl/desktop`. Groups with a
...
export type WorktreeResolver = (cwd: string) => XiaobanWorktreeInfo | null | undefined
