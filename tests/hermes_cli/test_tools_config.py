...
def test_save_platform_tools_preserves_mcp_server_names():
    ...
    Regression test for https://github.com/52707407SXG/Xiaoban-Agent/issues/1247
    """
    config = {
        "platform_toolsets": {
...
def test_save_platform_tools_does_not_preserve_platform_default_toolsets():
    ...
    ``xiaoban tools``, but hermes-cli stays in the config and re-enables
...
def test_numeric_mcp_server_name_does_not_crash_sorted():
    ...
    Regression test for https://github.com/52707407SXG/Xiaoban-Agent/issues/6901
    """
    config = {
