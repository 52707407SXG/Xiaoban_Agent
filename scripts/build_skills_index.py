#!/usr/bin/env python3
"""Build the Xiaoban Skills Index — a centralized JSON catalog of all skills.
...
`xiaoban skills search/install` can use it without hitting the GitHub API.
...
# Ensure XIAOBAN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Xiaoban Skills Index...", flush=True)
