 ...
 *
 * Plugins call window.__XIAOBAN_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__XIAOBAN_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__XIAOBAN_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__XIAOBAN_PLUGIN_SDK__ = {
    ...
    // window.__XIAOBAN_SESSION_TOKEN__ directly.
    authedFetch,
