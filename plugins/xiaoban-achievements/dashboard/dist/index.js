(function () {
  ...
  // Bundled into xiaoban-agent. Upstream repo remains the staging ground for new
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("HERMES AGENT  ·  github.com/52707407SXG/Xiaoban_Agent", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Xiaoban-Agent ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NousResearch · https://github.com/52707407SXG/Xiaoban_Agent";
    }
