...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/52707407SXG/Xiaoban_Agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/52707407SXG/Xiaoban_Agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
