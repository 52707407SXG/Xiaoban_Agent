...
sidebar_position: 7
title: "Email"
description: "Set up Xiaoban-Agent as an email assistant via IMAP/SMTP"
---
...
| **Duplicate replies** | Ensure only one gateway instance is running. Check `xiaoban gateway status`. |
