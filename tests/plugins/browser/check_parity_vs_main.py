...
Run from the PR worktree:
    ...
    cd ~/.hermes/xiaoban-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.hermes/xiaoban-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.hermes/xiaoban-agent
