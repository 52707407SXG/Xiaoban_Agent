...
slug: /
sidebar_position: 0
title: "Xiaoban-Agent Documentation"
...
After installing, run `xiaoban setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Xiaoban-Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Xiaoban-Agent safely  |
| 🧭 **[Use MCP with Xiaoban-Agent](/guides/use-mcp-with-xiaoban)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Xiaoban-Agent](/guides/use-voice-mode-with-xiaoban)** | Hands-on setup and usage patterns for Xiaoban-Agent voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Xiaoban-Agent' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Xiaoban-Agent                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Xiaoban-Agent, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Xiaoban-Agent, Nomos, and Psyche models
