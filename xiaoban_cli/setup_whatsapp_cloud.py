...
Entry point: ``xiaoban whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``xiaoban_cli/main.py``).
...
Xiaoban gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print()
    print("M WhatsApp Business Cloud API Setup")
    print("=" * 50)
    print()
    print("This wizard configures Xiaoban to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Xiaoban needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Xiaoban gateway in another terminal:")
    print("         xiaoban gateway")
    print()
    ...
    print()
    print("  Docs: https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/")
