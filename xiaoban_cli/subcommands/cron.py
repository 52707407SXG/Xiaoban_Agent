"""``xiaoban cron`` subcommand parser.

Extracted verbatim from ``xiaoban_cli/main.py:main()`` — same arguments, same
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.xiaoban/scripts/. Default mode: "
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.xiaoban/scripts/. Pass empty string to clear. "
