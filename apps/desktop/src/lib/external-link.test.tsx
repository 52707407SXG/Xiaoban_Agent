...
const desktopWindow = window as unknown as { xiaobanDesktop?: Window['xiaobanDesktop'] }
const initialXiaobanDesktop = desktopWindow.xiaobanDesktop

function installDesktopBridge(partial: Partial<Window['xiaobanDesktop']> = {}) {
  desktopWindow.xiaobanDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['xiaobanDesktop']
}
...
afterEach(() => {
  ...
  if (initialXiaobanDesktop) {
    desktopWindow.xiaobanDesktop = initialXiaobanDesktop
  } else {
    delete desktopWindow.xiaobanDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['xiaobanDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['xiaobanDesktop']['openExternal'] })
