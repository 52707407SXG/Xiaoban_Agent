...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Xiaoban's web-provider config and
        ...
        # native search engine for xAI sessions instead of Xiaoban's
        # configured web provider (Tavily/etc.), and those results bypass
        # Xiaoban's tool-trace / citation plumbing (they arrive baked into the
