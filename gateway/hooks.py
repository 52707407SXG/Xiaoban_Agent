...
Hooks are discovered from ~/.xiaoban/hooks/ directories, each containing:
...
HOOKS_DIR = get_xiaoban_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"xiaoban_hook_{hook_name}"
