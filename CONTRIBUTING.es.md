...
├── website/                  # Sitio de documentación (github.com/52707407SXG/Xiaoban-Agent)
│
...
- Usa [GitHub Issues](https://github.com/52707407SXG/Xiaoban-Agent/issues)
- Incluye: SO, versión de Python, versión de Hermes (`xiaoban version`), traza de error completa
