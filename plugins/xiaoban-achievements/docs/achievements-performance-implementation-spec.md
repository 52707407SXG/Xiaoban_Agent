# Xiaoban Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.xiaoban/plugins/xiaoban-achievements/state.json` (existing unlock state)
  - `~/.xiaoban/plugins/xiaoban-achievements/scan_snapshot.json` (new)
  - `~/.xiaoban/plugins/xiaoban-achievements/scan_checkpoint.json` (new)
