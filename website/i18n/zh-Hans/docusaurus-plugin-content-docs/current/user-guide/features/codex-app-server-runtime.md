...
（只要你的覆盖配置位于 `# managed by xiaoban-agent` 标记之外，Hermes 在重新迁移时会保留它。）
...
如果你发现 bug，请[提交 issue](https://github.com/52707407SXG/Xiaoban-Agent/issues)，附上 `xiaoban logs --since 5m` 的输出。在标题中注明 `codex-runtime` 以便于分类处理。
...
有关实现细节，请参阅 [PR #24182](https://github.com/52707407SXG/Xiaoban-Agent/pull/24182) 和 [Codex app-server 协议 README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md)。