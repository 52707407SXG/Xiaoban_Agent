...
Usage:
    xiaoban pairing list              # Show all pending + approved users
    xiaoban pairing approve <platform> <code>  # Approve a pairing code
    xiaoban pairing revoke <platform> <user_id> # Revoke user access
    xiaoban pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle xiaoban pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: xiaoban pairing {list|approve|revoke|clear-pending}")
        print("Run 'xiaoban pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.xiaoban/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'xiaoban pairing list' to see pending codes.\n")
