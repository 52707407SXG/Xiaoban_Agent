...
The notice prints the most recent curator run summary on `xiaoban update`,
...
session start) so users normally never see the rename map. `xiaoban update`
