...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/health/neuroskill-bci` |
...
Connect Xiaoban to a running [NeuroSkill](https://neuroskill.com/) instance to read
