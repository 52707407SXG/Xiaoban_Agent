...
import { api, XIAOBAN_BASE_PATH, buildWsAuthParam } from "@/lib/api";
...
export function ChatSidebar({
  ...
  // /api/events in xiaoban_cli/web_server.py for the broadcast hop.
  //
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      ws = new WebSocket(
        `${proto}//${window.location.host}${XIAOBAN_BASE_PATH}/api/events?${qs.toString()}`,
      );
