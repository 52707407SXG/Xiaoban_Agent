# Xiaoban Xiaoban Runtime Fork Strategy
...
It is a My Stand native Agent built on a mature Xiaoban runtime fork:

- Xiaoban provides the runtime chassis: conversation loop, tools, skills,
...
Some internal names such as `xiaoban_cli`, `XIAOBAN_HOME`, and old import paths
