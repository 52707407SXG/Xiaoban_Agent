...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/xiaoban'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('xiaoban:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('xiaoban:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
