...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateXiaoban: "Xiaoban'i Güncelle",
    updatingXiaoban: "Xiaoban güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Xiaoban eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`xiaoban plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.xiaoban/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.xiaoban/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.xiaoban/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Xiaoban rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Xiaoban oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Xiaoban'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Xiaoban ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Xiaoban yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
