...
# ہرمیس ایجنٹ ☤ (Xiaoban-Agent)

<p align="center">
  <a href="https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/"><img src="https://img.shields.io/badge/Docs-xiaoban--agent.nousresearch.com-FFD700?style=for-the-badge" alt="Documentation"></a>
  <a href="https://discord.gg/NousResearch"><img src="https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Discord"></a>
  <a href="https://github.com/52707407SXG/Xiaoban_Agent/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT"></a>
...
```bash
xiaoban              # انٹرایکٹو CLI — بات چیت شروع کریں
xiaoban model        # اپنا LLM پرووائیڈر اور ماڈل منتخب کریں
xiaoban tools        # کنفیگر کریں کہ کون سے ٹولز ایکٹو ہیں
xiaoban config set   # انفرادی کنفگ (config) ویلیوز سیٹ کریں
xiaoban gateway      # میسجنگ گیٹ وے شروع کریں (ٹیلی گرام، ڈسکارڈ، وغیرہ)
xiaoban setup        # مکمل سیٹ اپ وزرڈ چلائیں (یہ سب کچھ ایک ساتھ کنفیگر کر دے گا)
xiaoban claw migrate # OpenClaw سے مائیگریٹ کریں (اگر آپ OpenClaw سے آ رہے ہیں)
...
📖 **[مکمل دستاویزات →](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/)**
...
یہ آپ کو OAuth کے ذریعے لاگ ان کرواتا ہے، Nous کو آپ کا پرووائیڈر مقرر کرتا ہے، اور ٹول گیٹ وے کو آن کر دیتا ہے۔ `xiaoban portal info` کمانڈ استعمال کر کے آپ کسی بھی وقت چیک کر سکتے ہیں کہ کون کون سی سروسز منسلک ہیں۔ مکمل تفصیلات [Tool Gateway دستاویزات کے صفحے](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/tool-gateway) پر موجود ہیں۔
...
ہرمیس کے دو بنیادی انٹر فیس ہیں: آپ ٹرمینل UI کو `xiaoban` کے ساتھ شروع کریں، یا گیٹ وے چلا کر اس کے ساتھ ٹیلی گرام، ڈسکارڈ، سلیک، واٹس ایپ، سگنل، یا ای میل کے ذریعے بات کریں۔ جب آپ کسی بات چیت میں ہوتے ہیں، تو بہت سی سلیش (slash) کمانڈز دونوں انٹرفیسز میں ایک جیسی ہوتی ہیں۔

<div dir="ltr">

| کارروائی (Action)                         | سی ایل آئی (CLI)                              | میسجنگ پلیٹ فارمز (Messaging platforms)                                          |
| --------------------------------------- | --------------------------------------------- | -------------------------------------------------------------------------------- |
| بات چیت شروع کریں                       | `xiaoban`                                      | `xiaoban gateway setup` اور `xiaoban gateway start` چلائیں، پھر بوٹ کو میسج بھیجیں |
...
مکمل کمانڈ لسٹ کے لیے، [CLI گائیڈ](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/cli) اور [میسجنگ گیٹ وے گائیڈ](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/messaging) دیکھیں۔

---

## دستاویزات (Documentation)

تمام دستاویزات **[github.com/52707407SXG/Xiaoban_Agent/docs](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/)** پر موجود ہیں:

<div dir="ltr">

| سیکشن (Section)                                                                                     | تفصیل (What's Covered)                                     |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [فوری آغاز (Quickstart)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/getting-started/quickstart)     | انسٹالیشن → سیٹ اپ → 2 منٹ میں پہلی بات چیت شروع کریں       |
| [CLI کا استعمال](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/cli)                         | کمانڈز، کی بائنڈنگز (keybindings)، پرسنلٹیز (personalities)، سیشنز |
| [کنفیگریشن (Configuration)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/configuration)    | کنفگ فائل، پرووائیڈرز، ماڈلز، اور تمام آپشنز               |
| [میسجنگ گیٹ وے](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/messaging)                    | ٹیلی گرام، ڈسکارڈ، سلیک، واٹس ایپ، سگنل، ہوم اسسٹنٹ         |
| [سیکیورٹی (Security)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/security)              | کمانڈ کی منظوری، DM پیئرنگ (pairing)، کنٹینر آئسولیشن       |
| [ٹولز اور ٹول سیٹس](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/tools)          | 40 سے زائد ٹولز، ٹول سیٹ سسٹم، ٹرمینل بیک اینڈز             |
| [مہارتوں کا سسٹم (Skills System)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/skills)| پروسیجرل (Procedural) میموری، سکلز ہب، نئی مہارتیں بنانا    |
| [میموری (Memory)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/memory)            | مستقل میموری، یوزر پروفائلز، بہترین طریقہ کار              |
| [MCP انضمام (Integration)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/mcp)      | صلاحیتوں کو بڑھانے کے لیے کسی بھی MCP سرور کو جوڑیں        |
| [کرون (Cron) شیڈیولنگ](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/cron)         | پلیٹ فارم ڈیلیوری کے ساتھ شیڈول کیے گئے کام                 |
| [کانٹیکسٹ (Context) فائلز](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/user-guide/features/context-files)| پروجیکٹ کا سیاق و سباق (context) جو ہر بات چیت پر اثر انداز ہوتا ہے |
| [آرکیٹیکچر (Architecture)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/developer-guide/architecture) | پروجیکٹ کا ڈھانچہ، ایجنٹ لوپ، اہم کلاسز                    |
| [تعاون (Contributing)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/developer-guide/contributing)     | ڈیویلپمنٹ سیٹ اپ، PR کا طریقہ کار، کوڈنگ کا انداز          |
| [CLI حوالہ جات (Reference)](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/reference/cli-commands)      | تمام کمانڈز اور فلیگز (flags)                              |
| [انوائرمنٹ ویری ایبلز](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/reference/environment-variables)  | مکمل انوائرمنٹ ویری ایبل حوالہ جات                         |
...
**پہلی بار سیٹ اپ کے دوران:** سیٹ اپ وزرڈ (`xiaoban setup`) خود بخود `~/.openclaw` کو پہچان لیتا ہے اور کنفیگریشن شروع ہونے سے پہلے مائیگریٹ (migrate) کرنے کا آپشن دیتا ہے۔
...
```bash
xiaoban claw migrate              # انٹرایکٹو مائیگریشن (مکمل پری سیٹ)
xiaoban claw migrate --dry-run    # جائزہ لیں کہ کیا کیا مائیگریٹ ہوگا
xiaoban claw migrate --preset user-data   # حساس معلومات (secrets) کے بغیر مائیگریٹ کریں
xiaoban claw migrate --overwrite  # موجودہ متصادم فائلوں کو اوور رائٹ کریں
```
...
- **مہارتیں (Skills)** — صارف کی بنائی گئی مہارتیں → `~/.xiaoban/skills/openclaw-imports/`
...
تمام آپشنز دیکھنے کے لیے `xiaoban claw migrate --help` استعمال کریں، یا انٹرایکٹو ایجنٹ کی مدد سے مائیگریٹ کرنے کے لیے `openclaw-migration` سکل کا استعمال کریں (جس میں ڈرائی رن (dry-run) پریویوز شامل ہیں)۔

---

## تعاون کریں (Contributing)

ہم آپ کے تعاون کا خیرمقدم کرتے ہیں! ڈیویلپمنٹ سیٹ اپ، کوڈ کے انداز اور PR کے طریقہ کار کے لیے براہ کرم ہماری [Contributing گائیڈ](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/developer-guide/contributing) دیکھیں۔

معاونین (contributors) کے لیے فوری آغاز — کلون (clone) کریں اور `setup-xiaoban.sh` چلائیں:
...
cd xiaoban-agent
./setup-xiaoban.sh     # uv کو انسٹال کرتا ہے، venv بناتا ہے، .[all] کو انسٹال کرتا ہے، اور ~/.local/bin/xiaoban کا سیم لنک (symlink) بناتا ہے
./xiaoban              # خود بخود venv کی شناخت کرتا ہے، پہلے `source` کرنے کی ضرورت نہیں
```
...
- 🐛 [مسائل (Issues)](https://github.com/52707407SXG/Xiaoban_Agent/issues)
...
- 🔌 [XiaobanClaw](https://github.com/AaronWong1999/xiaobanclaw) — کمیونٹی وی چیٹ (WeChat) برج: ہرمیس ایجنٹ اور OpenClaw کو ایک ہی وی چیٹ اکاؤنٹ پر چلائیں۔
