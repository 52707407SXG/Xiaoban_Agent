...
If you're expecting jobs to fire automatically, you need a running gateway (`xiaoban gateway` for foreground, or `xiaoban gateway start` for the installed service). For one-off debugging, you can manually trigger a tick with `hermes cron tick`.
...
xiaoban logs                         # View recent Hermes logs
...
3. Open an issue at [github.com/52707407SXG/Xiaoban-Agent](https://github.com/52707407SXG/Xiaoban-Agent) with:
