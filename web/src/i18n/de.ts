...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateXiaoban: "Xiaoban aktualisieren",
    updatingXiaoban: "Xiaoban wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Xiaoban-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `xiaoban plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.xiaoban/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.xiaoban/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.xiaoban/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Xiaoban-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Xiaoban-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Xiaoban mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Xiaoban ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Xiaoban scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
