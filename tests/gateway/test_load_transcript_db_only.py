...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.xiaoban/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at xiaoban_state import time, before pytest's XIAOBAN_HOME monkeypatch
    fires — the autouse fixture's XIAOBAN_HOME override doesn't help here.)
    """
