...
import { getXiaobanConfigRecord, type XiaobanGateway, saveXiaobanConfig } from '@/xiaoban'
...
function getServers(config: XiaobanConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveXiaobanConfig(nextConfig)
