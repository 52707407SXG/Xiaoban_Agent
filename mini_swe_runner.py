#!/usr/bin/env python3
"""
SWE Runner with Xiaoban Trajectory Format

A runner that uses Xiaoban-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Xiaoban-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Xiaoban-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Xiaoban format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Xiaoban-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Xiaoban-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Xiaoban Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Xiaoban-Agent's built-in execution environments
    and outputs trajectories in Xiaoban-Agent format.
    """
    ...
    def _convert_to_xiaoban_format(
        self,
        ...
        """
        Convert internal message format to Xiaoban trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Xiaoban trajectory format
        trajectory = self._convert_to_xiaoban_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Xiaoban trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Xiaoban Trajectory Format")
    print("=" * 60)
