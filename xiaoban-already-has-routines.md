# Xiaoban-Agent Has Had "Routines" Since March
...
Xiaoban equivalent — works today:
```bash
...
Xiaoban equivalent — works today:
```bash
xiaoban webhook subscribe auth-watch \
  --events "pull_request" \
...
Every use case in their blog post — backlog triage, docs drift, deploy verification, alert correlation, library porting, bespoke PR review — has a working Xiaoban implementation. No new features needed. It's been shipping since March 2026.

---

## What's Different

| | Claude Code Routines | Xiaoban-Agent |
|---|---|---|
...
## Things Xiaoban Does That Routines Can't
...
Xiaoban has no daily limit. Run 500 automations a day if you want. The only constraint is your API budget, and you choose which models to use for which tasks.
...
Xiaoban-Agent is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.
...
```bash
xiaoban gateway setup    # enable webhooks
xiaoban webhook subscribe pr-review \
  --events "pull_request" \
...
Full automation blueprints gallery: [github.com/52707407SXG/Xiaoban_Agent/docs/reference/automation-blueprints-catalog](https://github.com/52707407SXG/Xiaoban_Agent/tree/main/website/docs/reference/automation-blueprints-catalog)

Documentation: [github.com/52707407SXG/Xiaoban_Agent](https://github.com/52707407SXG/Xiaoban_Agent)

GitHub: [github.com/52707407SXG/Xiaoban_Agent](https://github.com/52707407SXG/Xiaoban_Agent)

---

*Xiaoban-Agent is built by [Nous Research](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*
