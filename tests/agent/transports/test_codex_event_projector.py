"""Tests for CodexEventProjector — codex item/* events → Xiaoban messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Xiaoban' message alternation invariant."""
