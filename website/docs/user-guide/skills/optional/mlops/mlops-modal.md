...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/52707407SXG/Xiaoban_Agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/52707407SXG/Xiaoban_Agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
