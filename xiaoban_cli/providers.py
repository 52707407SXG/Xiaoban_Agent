"""
Single source of truth for provider identity in Xiaoban-Agent.
...
2. **Xiaoban overlays** — transport type, auth patterns, aggregator flags,
...
# -- Xiaoban overlay ----------------------------------------------------------
# Xiaoban-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class XiaobanOverlay:
    """Xiaoban-specific provider metadata layered on top of models.dev."""
...
XIAOBAN_OVERLAYS: Dict[str, XiaobanOverlay] = {
    "openrouter": XiaobanOverlay(
    ...
    "openai-codex": XiaobanOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://chatgpt.com/backend-api/codex",
    ),
    "openai-api": XiaobanOverlay(
        transport="codex_responses",
        base_url_override="https://api.openai.com/v1",
        base_url_env_var="OPENAI_BASE_URL",
    ),
    "xai-oauth": XiaobanOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://api.x.ai/v1",
        base_url_env_var="XAI_BASE_URL",
    ),
    "qwen-oauth": XiaobanOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="https://portal.qwen.ai/v1",
        base_url_env_var="XIAOBAN_QWEN_BASE_URL",
    ),
    "lmstudio": XiaobanOverlay(
        transport="openai_chat",
        auth_type="api_key",
    ...
    "copilot-acp": XiaobanOverlay(
        transport="codex_responses",
        auth_type="external_process",
        base_url_override="acp://copilot",
        base_url_env_var="COPILOT_ACP_BASE_URL",
    ),
    "github-copilot": XiaobanOverlay(
        transport="openai_chat",
        extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN"),
    ),
    "anthropic": XiaobanOverlay(
    ...
    "kimi-for-coding": XiaobanOverlay(
        transport="openai_chat",
        base_url_env_var="KIMI_BASE_URL",
    ),
    "stepfun": XiaobanOverlay(
        transport="openai_chat",
        extra_env_vars=("STEPFUN_API_KEY",),
        base_url_override="https://api.stepfun.ai/step_plan/v1",
        base_url_env_var="STEPFUN_BASE_URL",
    ),
    "minimax": XiaobanOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_BASE_URL",
    ),
    "minimax-oauth": XiaobanOverlay(
        transport="anthropic_messages",
        auth_type="oauth_external",
        base_url_override="https://api.minimax.io/anthropic",
    ),
    "minimax-cn": XiaobanOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_CN_BASE_URL",
    ),
    "deepseek": XiaobanOverlay(
        transport="openai_chat",
        base_url_env_var="DEEPSEEK_BASE_URL",
    ),
    "alibaba": XiaobanOverlay(
        transport="openai_chat",
        base_url_env_var="DASHSCOPE_BASE_URL",
    ),
    "alibaba-coding-plan": XiaobanOverlay(
        transport="openai_chat",
        base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL",
    ),
    "opencode": XiaobanOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENCODE_ZEN_BASE_URL",
    ),
    "opencode-go": XiaobanOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "huggingface": XiaobanOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="HF_BASE_URL",
    ),
    "novita": XiaobanOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "nvidia": XiaobanOverlay(
        transport="openai_chat",
        base_url_override="https://integrate.api.nvidia.com/v1",
        base_url_env_var="NVIDIA_BASE_URL",
    ),
    "xiaomi": XiaobanOverlay(
        transport="openai_chat",
        base_url_env_var="XIAOMI_BASE_URL",
    ),
    "tencent-tokenhub": XiaobanOverlay(
        transport="openai_chat",
        base_url_env_var="TOKENHUB_BASE_URL",
    ),
    "arcee": XiaobanOverlay(
        transport="openai_chat",
    ...
    "azure-foundry": XiaobanOverlay(
        transport="openai_chat",  # default; overridden by api_mode in config
        base_url_env_var="AZURE_FOUNDRY_BASE_URL",
    ),
    "bedrock": XiaobanOverlay(
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "xiaoban", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Xiaoban overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + Xiaoban overlay
    ...
    overlay = XIAOBAN_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + xiaoban extra
    ...
    if overlay is not None:
        # Xiaoban-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in XIAOBAN_OVERLAYS
    if provider == "bedrock":
