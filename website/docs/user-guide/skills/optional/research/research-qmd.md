...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/research/qmd` |
...
Xiaoban-Agent via the native MCP client. This is the preferred
...
Then configure Xiaoban-Agent to connect via HTTP:
