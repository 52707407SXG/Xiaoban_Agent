...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from xiaoban_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in XIAOBAN_OVERLAYS
        overlay = XIAOBAN_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify xiaoban doctor recognizes Xiaomi env vars."""
