...
The main() function in xiaoban_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `xiaoban -c model`
...
def _build_parser():
    """Build a minimal replica of the xiaoban top-level parser."""
