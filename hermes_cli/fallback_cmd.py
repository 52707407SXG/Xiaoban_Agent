...
Subcommands:
  ...
  hermes fallback add      Pick provider + model via the same picker as `xiaoban model`,
...
def cmd_fallback_list(args) -> None:  # noqa: ARG001
    ...
    print("  Docs: https://xiaoban-agent.nousresearch.com/docs/user-guide/features/fallback-providers")
    print()
