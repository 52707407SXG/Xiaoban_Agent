...
projection into Xiaoban' display, approval bridging, transcript projection into
...
"codex_app_server"`. Xiaoban' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("XIAOBAN_KANBAN_TASK"):
            kanban_db = spawn_env.get("XIAOBAN_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "XIAOBAN_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("XIAOBAN_HOME", os.path.expanduser("~/.xiaoban")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "xiaoban",
        client_title: str = "Xiaoban-Agent",
