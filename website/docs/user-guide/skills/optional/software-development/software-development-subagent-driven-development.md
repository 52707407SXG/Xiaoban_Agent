...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Xiaoban-Agent (adapted from obra/superpowers) |
| License | MIT |
