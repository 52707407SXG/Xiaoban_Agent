...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Xiaoban-Agent |
| License | MIT |
...
```
SCRIPT=~/.xiaoban/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.xiaoban/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
