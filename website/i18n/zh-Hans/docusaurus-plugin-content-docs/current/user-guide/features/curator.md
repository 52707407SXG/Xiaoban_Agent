...
跟踪 [issue #7816](https://github.com/52707407SXG/Xiaoban-Agent/issues/7816)。
...
- `~/.hermes/skills/.hub/lock.json`（通过 `xiaoban skills install` 安装的技能）。
...
- [Issue #7816](https://github.com/52707407SXG/Xiaoban-Agent/issues/7816)——原始提案与设计讨论