...
DEFAULT_DATASETS = [
    ...
    "NousResearch/xiaoban-agent-megascience-sft1",
    "NousResearch/Xiaoban-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Xiaoban-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-xiaoban-agent"
]
