 ...
 *
 * Values mirror xiaoban_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Xiaoban default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Xiaoban' default when unset). */
