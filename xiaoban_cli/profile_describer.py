...
Used by ``xiaoban profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``xiaoban_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Xiaoban-Agent kanban board.
...
Rules:
  ...
  - Never write "Xiaoban-Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_xiaoban_home())
        else:
