...
SPOTIFY_DOCS_URL = "https://xiaoban-agent.nousresearch.com/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

XAI_OAUTH_DOCS_URL = "https://xiaoban-agent.nousresearch.com/docs/guides/xai-grok-oauth"
OAUTH_OVER_SSH_DOCS_URL = "https://xiaoban-agent.nousresearch.com/docs/guides/oauth-over-ssh"
    ...
    *,
    ...
    if normalized != "auto":
        ...
        if _config_hint:
            ...
            msg += " Check 'xiaoban model' for available providers, or run 'hermes doctor' to diagnose config issues."
...
def _read_codex_tokens(*, _lock: bool = True) -> Dict[str, Any]:
    """Read Codex OAuth tokens from Xiaoban auth store (~/.hermes/auth.json).
...
def _save_codex_tokens(tokens: Dict[str, str], last_refresh: str = None, label: str = None) -> None:
    """Save Codex OAuth tokens to Xiaoban auth store (~/.hermes/auth.json)."""
    ...
    *,
    ...
    if code == "refresh_token_reused" or "reuse" in lowered or "reuse detected" in lowered:
        description = (
            ...
            "~/.hermes/auth.json) called POST /api/oauth/token with Xiaoban's "
    ...
    *,
    ...
    if not code_verifier:
        raise AuthError(
            ...
            "https://github.com/NousResearch/xiaoban-agent/issues/26990.",
            provider="xai-oauth",
...
def _minimax_save_auth_state(auth_state: Dict[str, Any]) -> None:
    """Persist MiniMax OAuth state to Xiaoban auth store (~/.hermes/auth.json)."""
    with _auth_store_lock():
        auth_store = _load_auth_store()
