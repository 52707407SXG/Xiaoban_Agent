"""Tests for `xiaoban curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import xiaoban_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated XIAOBAN_HOME with real agent-created skills on disk."""
    ...
    from xiaoban_cli import curator as curator_cli
