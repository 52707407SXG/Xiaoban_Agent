...
(3 SDK retries x 3 Xiaoban retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_xiaoban_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".xiaoban")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Xiaoban, ...) behind one endpoint.  A 429 can mean either:
