"""Tests for the interactive session browser (`xiaoban sessions browse`).
...
from xiaoban_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """xiaoban sessions browse should be parseable."""
