...
def register_cli(parser: argparse.ArgumentParser) -> None:
    ...
    p_setup.add_argument("--project-name", default=None,
                         help="Project name (default: 'Xiaoban-Agent')")
...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    # 2. Find or create the "Xiaoban-Agent" project.
    ...
    print("  Start the gateway:  xiaoban gateway start")
    return 0
...
#
# `xiaoban gateway setup` discovers platforms via the registry and calls each
...
def gateway_setup() -> None:
    """Run Photon first-time setup from the `xiaoban gateway setup` wizard."""
