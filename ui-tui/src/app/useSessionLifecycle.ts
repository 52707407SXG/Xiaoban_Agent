...
import type { ScrollBoxHandle } from '@xiaoban/ink'
import { evictInkCaches } from '@xiaoban/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.XIAOBAN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
