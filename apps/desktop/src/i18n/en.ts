...
export const en: Translations = {
  ...
  boot: {
    ready: 'Xiaoban Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Xiaoban settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingXiaobanDesktop: 'Starting Xiaoban Desktop…'
    },
    errors: {
      backgroundExited: 'Xiaoban background process exited.',
      backgroundExitedDuringStartup: 'Xiaoban background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Xiaoban backend is older than this desktop build and may not work correctly. Update to align them.',
    updateXiaoban: 'Update Xiaoban',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Xiaoban Desktop.',
    ...
    native: {
      ...
      inputBody: 'Xiaoban is waiting for your response.',
      turnDoneTitle: 'Xiaoban finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Xiaoban defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Xiaoban is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Xiaoban asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Xiaoban was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Xiaoban follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Xiaoban checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Xiaoban configuration...',
    ...
    gateway: {
      ...
      intro:
        'Xiaoban Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Xiaoban backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset XIAOBAN_DESKTOP_REMOTE_URL and XIAOBAN_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Xiaoban backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Xiaoban backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /xiaoban.',
      ...
      restartingMessage: 'Xiaoban Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Xiaoban ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Xiaoban runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Xiaoban desktop' },
    ...
    xiaobanActiveSessions: (version, count) => `Xiaoban ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@xiaoban:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Xiaoban environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Xiaoban will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Xiaoban...',
    placeholderReconnecting: 'Reconnecting to Xiaoban…',
    ...
    attachUrlDesc: 'Xiaoban will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Xiaoban…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Xiaoban…',
    ...
    unsupportedMessage: 'This version of Xiaoban can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Xiaoban from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Xiaoban will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Xiaoban desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Xiaoban updater takes over in its own window and reopens Xiaoban automatically when it’s done. Please don’t reopen Xiaoban yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Xiaoban reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Xiaoban reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Xiaoban needs a one-time install',
    ...
    settingUpTitle: 'Setting up Xiaoban-Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Xiaoban CLI or desktop instance is running. Stop any running Xiaoban instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Xiaoban installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Xiaoban-Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Xiaoban is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Xiaoban…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Xiaoban',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Xiaoban at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Xiaoban connects automatically',
      loopback: 'Opens your browser to sign in — Xiaoban connects automatically',
    ...
    authorizeThere: 'Authorize Xiaoban there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Xiaoban there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Xiaoban inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Xiaoban will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Xiaoban is restarting...',
      askRestart: 'Ask Xiaoban to restart the server',
      lookingRestart: taskId => `Xiaoban is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Xiaoban is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Xiaoban finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Xiaoban could not restart the server.',
      stillWorking:
        'Xiaoban is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Xiaoban is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Xiaoban gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.xiaoban/config.yaml). Xiaoban won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Xiaoban needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Xiaoban needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Xiaoban Desktop to use Save Image.',
    restartToSaveImages: 'Restart Xiaoban Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `xiaoban gateway` running?'
    }
  },
