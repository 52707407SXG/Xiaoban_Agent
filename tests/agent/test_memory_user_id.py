...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_xiaoban_user(self):
        """Without user_id or config override, should default to 'xiaoban-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "xiaoban-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"XIAOBAN_HOME": "/tmp/test_xiaoban"}):
