...
| | |
|---|---|
| Source | Optional — install with `xiaoban skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Xiaoban-Agent |
| License | MIT |
...
The script reads `${XIAOBAN_HOME:-~/.xiaoban}/.env` for two optional defaults:
...
Helper script: `~/.xiaoban/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.xiaoban/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${XIAOBAN_HOME:-~/.xiaoban}/.env`.
...
```bash
python3 ~/.xiaoban/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.xiaoban/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
