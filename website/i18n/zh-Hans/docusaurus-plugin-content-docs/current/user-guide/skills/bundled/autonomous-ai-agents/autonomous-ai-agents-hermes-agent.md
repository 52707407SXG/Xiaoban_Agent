...
Xiaoban-Agent 是 Nous Research 开发的开源 AI agent 框架，可在终端、消息平台和 IDE 中运行。它与 Claude Code（Anthropic）、Codex（OpenAI）和 OpenClaw 同属一类——使用工具调用（tool calling）与系统交互的自主编码和任务执行 agent。Hermes 支持任意 LLM 提供商（OpenRouter、Anthropic、OpenAI、DeepSeek、本地模型及 15+ 其他提供商），可在 Linux、macOS 和 WSL 上运行。
...
**文档：** https://github.com/52707407SXG/Xiaoban-Agent/docs/
...
平台文档：https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/messaging/
...
在交互式聊天会话中输入这些命令。新命令会不定期上线；如果以下内容看起来过时，请在会话内运行 `/help` 获取权威列表，或查看[实时斜杠命令参考](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/slash-commands)。命令注册表的权威来源是 `hermes_cli/commands.py` — 每个消费方（自动补全、Telegram 菜单、Slack 映射、`/help`）均从中派生。
...
完整配置参考：https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/configuration
...
完整提供商文档：https://github.com/52707407SXG/Xiaoban-Agent/docs/integrations/providers
...
用户文档：https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/cron
...
用户文档：https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/curator
...
用户文档：https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/kanban
...
| 查找内容... | 位置 |
|----------------|----------|
| 配置选项 | `hermes config edit` 或[配置文档](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/configuration) |
| 可用工具 | `xiaoban tools list` 或[工具参考](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/tools-reference) |
| 斜杠命令 | 会话内 `/help` 或[斜杠命令参考](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/slash-commands) |
| Skill 目录 | `xiaoban skills browse` 或[Skill 目录](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/skills-catalog) |
| 提供商设置 | `xiaoban model` 或[提供商指南](https://github.com/52707407SXG/Xiaoban-Agent/docs/integrations/providers) |
| 平台设置 | `xiaoban gateway setup` 或[消息文档](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/messaging/) |
| MCP 服务器 | `hermes mcp list` 或[MCP 指南](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` 或[Profiles 文档](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/profiles) |
| Cron 任务 | `hermes cron list` 或[Cron 文档](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/cron) |
| 记忆 | `hermes memory status` 或[记忆文档](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/memory) |
| 环境变量 | `hermes config env-path` 或[环境变量参考](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/environment-variables) |
| CLI 命令 | `hermes --help` 或[CLI 参考](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/cli-commands) |
| Gateway 日志 | `~/.hermes/logs/gateway.log` |
| 会话文件 | `~/.hermes/sessions/` 或 `hermes sessions browse` |
| 源代码 | `~/.hermes/xiaoban-agent/` |

---

## 贡献者快速参考

面向偶尔贡献者和 PR 作者。完整开发者文档：https://github.com/52707407SXG/Xiaoban-Agent/docs/developer-guide/
