...
Config: ~/.xiaoban/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.xiaoban/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_xiaoban_home()`` helper (XIAOBAN_HOME-aware and
...
RULES_FILE = get_xiaoban_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_xiaoban_home() / "feishu_comment_pairing.json"
