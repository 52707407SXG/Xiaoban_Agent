...
| [`xiaoban-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-xiaoban-agent) | Configure, extend, or contribute to Xiaoban-Agent. | `autonomous-ai-agents/xiaoban-agent` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Xiaoban CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`xiaoban-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-xiaoban-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/xiaoban-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write an actionable markdown plan to .xiaoban/plans/, no execution. Bite-sized tasks, exact paths, complete code. | `software-development/plan` |
