...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Xiaoban/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Xiaoban'
    ...
    # is stricter (low/high). Clamp Xiaoban' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Xiaoban-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Xiaoban-internal scaffolding markers (``_``-prefixed).
