  ...
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-xiaoban-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-xiaoban-agent-skill-authoring',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/devops/devops-xiaoban-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-xiaoban-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-xiaoban',
        'guides/use-soul-with-xiaoban',
        'guides/use-voice-mode-with-xiaoban',
        'guides/build-a-xiaoban-plugin',
