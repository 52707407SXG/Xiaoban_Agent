...
const TAKEOVER_KEY = 'xiaoban.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Xiaoban can't clear via the API — the user
 *  sees exactly what runs instead of Xiaoban silently deleting their creds. */
