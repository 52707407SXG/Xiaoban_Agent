...
metadata:
  hermes:
    ...
    homepage: https://github.com/52707407SXG/Xiaoban-Agent
...
**Docs:** https://github.com/52707407SXG/Xiaoban-Agent/docs/
...
- User documentation: https://github.com/52707407SXG/Xiaoban-Agent/docs/
- Source tree: https://github.com/52707407SXG/Xiaoban-Agent
...
(`hermes mcp install <name>`): `skill_view(name="xiaoban-agent", file_path="references/native-mcp.md")`.
...
Platform docs: https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/slash-commands).
...
~/.hermes/xiaoban-agent/     Source code (if git-installed)
```
...
Full config reference: https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/configuration
...
Full provider docs: https://github.com/52707407SXG/Xiaoban-Agent/docs/integrations/providers
...
- **Don't put project rules in `~/.hermes/AGENTS.md`** (or any other home-level location). When Hermes runs with that directory as cwd, the file loads — but only for that one directory. For cross-project context, use `SOUL.md` (in `$HERMES_HOME`, identity-only) or install a skill via `xiaoban skills install`.
...
User docs: https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/cron
...
User docs: https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/curator
...
User docs: https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/kanban
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/configuration) |
| Available tools | `xiaoban tools list` or [Tools reference](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/slash-commands) |
| Skills catalog | `xiaoban skills browse` or [Skills catalog](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/skills-catalog) |
| Provider setup | `xiaoban model` or [Providers guide](https://github.com/52707407SXG/Xiaoban-Agent/docs/integrations/providers) |
| Platform setup | `xiaoban gateway setup` or [Messaging docs](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://github.com/52707407SXG/Xiaoban-Agent/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](https://github.com/52707407SXG/Xiaoban-Agent/docs/reference/cli-commands) |
| Gateway logs | `~/.hermes/logs/gateway.log` |
| Session files | `hermes sessions browse` (reads state.db) |
| Source code | `~/.hermes/xiaoban-agent/` |

---

## Contributor Quick Reference

For occasional contributors and PR authors. Full developer docs: https://github.com/52707407SXG/Xiaoban-Agent/docs/developer-guide/
