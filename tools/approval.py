...
DANGEROUS_PATTERNS = [
    ...
    (r'\bhermes\s+gateway\s+(stop|restart)\b', "stop/restart xiaoban gateway (kills running agents)"),
    (r'\bhermes\s+update\b', "xiaoban update (restarts gateway, kills running agents)"),
