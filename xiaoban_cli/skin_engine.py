"""Xiaoban CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.xiaoban/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      ...
      response_label: " M Xiaoban "      # Response box header label
...
.. code-block:: python
    ...
    from xiaoban_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.xiaoban/skins/
...
Drop a YAML file in ``~/.xiaoban/skins/<name>.yaml`` following the schema above.
