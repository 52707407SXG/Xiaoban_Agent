...
The historical issue for this is [#19931](https://github.com/52707407SXG/Xiaoban-Agent/issues/19931) and the closed-not-merged Codex-specific PR [#19924](https://github.com/52707407SXG/Xiaoban-Agent/pull/19924) — those describe the original architecture proposal but didn't land a runner.
...
- [`KANBAN_GUIDANCE`](https://github.com/52707407SXG/Xiaoban-Agent/blob/main/agent/prompt_builder.py) — the worker + orchestrator lifecycle injected into every kanban worker's system prompt.
