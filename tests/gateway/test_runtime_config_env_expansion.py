...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("XIAOBAN_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("XIAOBAN_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("XIAOBAN_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
