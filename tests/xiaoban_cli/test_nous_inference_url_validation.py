...
class TestValidatorRules:
    ...
    def test_attacker_host_rejected(self, caplog):
        with caplog.at_level(logging.WARNING, logger="xiaoban_cli.auth"):
            assert (
...
class TestCallSiteWiring:
    ...
    def _read_auth_source(self):
        import xiaoban_cli.auth as _auth_mod
    ...
    def test_proxy_adapter_also_validates(self):
        ...
        boundary."""
        from pathlib import Path
        import xiaoban_cli.proxy.adapters.nous_portal as _nous_adapter
