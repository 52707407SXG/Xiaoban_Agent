...
"No LLM provider configured. Run `xiaoban model`..." (resume failed) or
...
import xiaoban_cli.runtime_provider as rp
...
def _make_agent_with_override(override, monkeypatch, config, model_cfg=None):
    ...
    # Keep credential-pool resolution off the developer's real XIAOBAN home.
