...
DEFAULT_UA = (
    "xiaoban-osint-investigation/0.2 "
    "(+https://github.com/52707407SXG/Xiaoban_Agent; "
    "set XIAOBAN_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("XIAOBAN_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
