"""``xiaoban tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'xiaoban tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # xiaoban tools list [--platform cli]
    ...
    # xiaoban tools disable <name...> [--platform cli]
    ...
    # xiaoban tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `xiaoban tools` runs after you pick a provider that\n"
